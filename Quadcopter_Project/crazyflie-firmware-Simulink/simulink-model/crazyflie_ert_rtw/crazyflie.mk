...
## Generated on : Fri May 03 14:28:52 2019
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/crazyflie_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=crazyflie -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
%.o : $(START_DIR)/crazyflie_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/crazyflie_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

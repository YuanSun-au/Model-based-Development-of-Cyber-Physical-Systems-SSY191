...
#include "nesl_rtw.h"
#include "open_loop_94817720_1.h"

void open_loop_94817720_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0, 0.01, 0, 0, 0, 0,
    (SscLoggingSetting) 1, 477246959, };
  ...
  open_loop_94817720_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("open_loop/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
